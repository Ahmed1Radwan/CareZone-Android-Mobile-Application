...
public class MedRemInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            weekdays_layout.setVisibility(View.GONE);
            freq_layout.setVisibility(View.GONE);
            frequency_rl.setVisibility(View.GONE);
        ...
        else if(unit.getText().equals("weeks"))
        {
            ...
            starting_time_layout.setVisibility(View.GONE);
        }
